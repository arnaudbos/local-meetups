...
There are four main parts of the dev/test environment. You can see these in the namespace local-meetups.jobs.sample-job-test.
...
Then try to run the test via your editor, or in the repl e.g. `(clojure.test/run-tests 'local-meetups.jobs.sample-job-test)`. 
