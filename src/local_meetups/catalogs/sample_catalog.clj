(ns local-meetups.catalogs.sample-catalog
    (:require [local-meetups.functions.sample-functions]))
...
(defn build-catalog [batch-size batch-timeout]
  [{:onyx/name :format-line
    :onyx/fn :local-meetups.functions.sample-functions/format-line
    :onyx/type :function
   ...
   {:onyx/name :upper-case
    :onyx/fn :local-meetups.functions.sample-functions/upper-case
    :onyx/type :function
    :onyx/batch-size batch-size
    :onyx/batch-timeout batch-timeout
   ...
   {:onyx/name :extract-meetup-info
    :onyx/fn :local-meetups.functions.sample-functions/transform-segment-shape
    :onyx/type :function
    :onyx/batch-size batch-size
    :onyx/batch-timeout batch-timeout
   ...
   {:onyx/name :prepare-rows
    :onyx/fn :local-meetups.functions.sample-functions/prepare-rows
    :onyx/type :function
    :onyx/batch-size batch-size
    :onyx/batch-timeout batch-timeout}])
